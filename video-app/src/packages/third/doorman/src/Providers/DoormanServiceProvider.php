...
namespace Third\Doorman\Providers;

use Third\Doorman\Doorman;
use Third\Doorman\Manager;
use Third\Doorman\Validation\DoormanValidator;
...
class DoormanServiceProvider extends ServiceProvider
{
    public function boot()
    {
        if ($this->app->runningInConsole()) {
            $this->commands([
                \Third\Doorman\Commands\CleanupCommand::class,
            ]);
        }
