...
namespace Third\Doorman\Test\Feature;
...
class RedeemInvitesTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Third\Doorman\Exceptions\InvalidInviteCode
    ...
    /**
     * @test
     * @expectedException \Third\Doorman\Exceptions\MaxUsesReached
    ...
    /**
     * @test
     * @expectedException \Third\Doorman\Exceptions\ExpiredInviteCode
    ...
    /**
     * @test
     * @expectedException \Third\Doorman\Exceptions\NotYourInviteCode
